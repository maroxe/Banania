# http://www.gamasutra.com/blogs/TimConkling/20150616/246253/A_2D_Level_Editor_in_30_Seconds.php
import csv


class Grid(object):
    '''Parses a csv file into a grid. Each cell in the grid is a list of strings,
    corresponding to the string that was in the corresponding cell in the
    spreadsheet split by the given 'cell_item_separator',
    which defaults to a comma'''
